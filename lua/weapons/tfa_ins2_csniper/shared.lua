...
SWEP.Category				= "TFA Nebulous (citation needed)" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
SWEP.Manufacturer = "Damn combine cock suckers !" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
SWEP.PrintName				= "Overwarch Sniper Rifle"		-- Weapon name (Shown on HUD)
...
SWEP.IronSightsPos_RDS = Vector(-2.22, -0.293, -1.1)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.212, -1, -1.081)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.22, -0.193, -1.05)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.22, -0.193, -0.85)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-2.214, -0.893, -1.058)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-2.22, -1.25, -0.677)
SWEP.IronSightsAng_PO4X = Vector(0, 0, 0)

SWEP.IronSightsPos_Mosin = Vector(-2.197, -0.093, -0.649)
